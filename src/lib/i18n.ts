...
const ja: Dictionary = {
  ...
  "graph.avg_reproduction_rate": "平均繁殖率",
  "graph.avg_size": "平均体格",
  "graph.rgb": "RGB分布",
...
const en: Dictionary = {
  ...
  "gene.reproduction_rate": "Reproduction Rate",
  ...
  "graph.avg_reproduction_rate": "Avg Reproduction",
