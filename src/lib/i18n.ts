...
const ja: Dictionary = {
  ...
  "start.life_count_preset_note":
    "世界地図など固定地形では、この数が「各地域（大陸）ごと」の初期個体数になります。",
  "start.initial_genes": "初期生命遺伝子",
  "start.seed": "シード値（任意）",
  "start.other_settings": "その他の設定",
  "start.map_world": "🌍 世界地図",
  ...
  "victory.turns": "所要ターン",
  "victory.avg_int": "勝者の平均知能",
  "victory.species": "出自内の系統数",
  "victory.population": "総個体数",
...
const en: Dictionary = {
  ...
  "start.life_count_preset_note":
    "On fixed-terrain maps (e.g. World), this is the initial count PER region (continent).",
  "start.initial_genes": "Initial Genes",
  "start.seed": "Seed (optional)",
  "start.other_settings": "Other settings",
  "start.map_world": "🌍 World Map",
  ...
  "victory.turns": "Turns",
  "victory.avg_int": "Winner avg. intelligence",
  "victory.species": "Lineages in origin",
  "victory.population": "Population",
