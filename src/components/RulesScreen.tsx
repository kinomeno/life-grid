  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        heading: "応援のお願い 🙇",
        lines: [
          "LIFE GRID は完全無料・登録不要で公開しています。",
          "もし楽しんでいただけたら、ちょっとした応援が",
          "今後のアップデートの大きな励みになります。",
          "",
          "☕ Ko-fi（投げ銭）― 登録不要・ゲスト支援OK・コーヒー1杯から",
          "　▶ https://ko-fi.com/kinomeno",
          "",
          "💛 note のチップ ― note をお使いの方はこちらから",
          "　▶ https://note.com/kinomeno/n/n95fdec908a26",
          "",
          "SNS でのシェアやご感想も、とても励みになります。",
          "今後ともどうぞよろしくお願いいたします。",
        ],
      },
    ],
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        ...
        lines: [
          "LIFE GRID is completely free, with no sign-up required.",
          "If you enjoy it, a little support is a big boost",
          "for future updates.",
          "",
          "☕ Ko-fi (tip) — no account needed, guest support OK, from the price of a coffee",
          "　▶ https://ko-fi.com/kinomeno",
          "",
          "💛 note tip — if you use note",
          "　▶ https://note.com/kinomeno/n/n95fdec908a26",
          "",
          "Sharing on social media or sending feedback means a lot, too.",
          "Thank you, and enjoy!",
        ],
      },
    ],
