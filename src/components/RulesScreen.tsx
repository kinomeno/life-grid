...
const SECTIONS_JA: Section[] = [
  {
    ...
    body: [
      ...
      },
      {
        ...
        lines: [
          "▼ 基本形質（8 種）",
          "色（R/G/B）／視野／移動速度／体格／強さ／知能／繁殖率／寿命。",
          "高性能ほど維持コスト増。完全な万能化は不可。",
          "",
          "▼ v1.10：行動判断の重み遺伝子（7 種、性格）",
          "食欲・捕食欲・警戒・社交性・強者追従・繁殖欲・飢餓敏感の 7 つを追加。",
          "知能の精度（accuracy）に応じて重みが反映され、性格が創発します。",
          "",
          "▼ v1.10：突然変異率は遺伝子から廃止",
          "全個体共通の固定値。環境設定の倍率（0〜2.0）で全体制御可能。",
          "",
          "▼ 強さ・知能 999 / 繁殖率 2.0 の上限拡張は v1.01 から継続",
          "通常レンジ（強さ・知能 0〜100、繁殖率 0〜0.4）が安定して生存可能。",
          "ミュータント個体は突然変異で稀に発生し、高い能力と引き換えに",
          "維持コストが指数的に上昇する。",
  ...
  },
  {
    ...
    body: [
      ...
      {
        heading: "知能の影響（v1.10 で全面刷新）",
        lines: [
          "知能 = 行動判断の精度（accuracy）。重み遺伝子が遺伝子通りに反映される度合いです。",
          "",
          "▼ 計算式：accuracy = min(1.0, sqrt(intelligence / 200))",
          "・知能   0：accuracy   0% → 完全ランダム移動",
          "・知能  50：accuracy  50% → 性格が薄く出る",
          "・知能 100：accuracy  71% → 性格が見え始める",
          "・知能 200：accuracy 100% → 重み遺伝子通り正確に行動",
          "・知能 200 超：完全機能 + 視野範囲ボーナス（最大 +7 マス）",
          "",
          "▼ 重み遺伝子 7 種が「性格」を決める",
          "個体は以下の特徴量を観察し、重み × 特徴量の線形和で行動を選びます。",
          "・食欲     (wAppetite)      ：セルのエネルギーへの引力",
          "・捕食欲   (wPredation)     ：倒せる獲物への引力",
          "・警戒     (wCaution)       ：倒せない敵への警戒（負方向）",
          "・社交性   (wGregarious)    ：仲間の数への引力",
          "・強者追従 (wLoyalty)       ：仲間の平均エネルギーへの引力",
          "・繁殖欲   (wRepro)         ：空きセル（繁殖機会）への引力",
